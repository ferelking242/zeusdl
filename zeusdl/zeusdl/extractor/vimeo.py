...
class VimeoBaseInfoExtractor(InfoExtractor):
    ...
    _REFERER_HINT = (
        'Cannot download embed-only video without embedding URL. Please call ZeusDL '
            ...
            for cdn_name, cdn_data in (try_get(config_files, lambda x: x[files_type]['cdns']) or {}).items():
                ...
                for f_id, m_url in sep_manifest_urls:
                    if files_type == 'hls':
                        ...
                        # See: https://github.com/ZeusDL/ZeusDL/issues/10854
                        for f in fmts:
    ...
    def _extract_original_format(self, url, video_id, unlisted_hash=None):
        ...
        if not traverse_obj(privacy_info, ('privacy', 'download', {bool})):
            ...
            if policy != 'always':
                self.write_debug(
                    f'{msg}, so ZeusDL is not attempting to extract the original/source format. '
...
class VimeoIE(VimeoBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        # chapters must be sorted, see: https://github.com/ZeusDL/ZeusDL/issues/5308
    ...
    _WEBPAGE_TESTS = [{
        ...
        # https://github.com/ZeusDL/ZeusDL/commit/a1a460759815414c6194bc921ac77a5533b6e02e
