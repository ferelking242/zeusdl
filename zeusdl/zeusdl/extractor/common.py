...
class InfoExtractor:
    ...
    formats:        A list of dictionaries for each format available, ordered
                    ...
                    * impersonate  Impersonate target(s). Can be any of the following entities:
                                * an instance of zeusdl.networking.impersonate.ImpersonateTarget
    ...
    webpage_url:    The URL to the video webpage, if given to ZeusDL it
    ...
    _old_archive_ids: A list of old archive ids needed for backward
                   compatibility. Use zeusdl.utils.make_archive_id to generate ids
    ...
    def _login_hint(self, method=NO_DEFAULT, netrc=None):
        ...
        cookies_hint = 'See  https://github.com/ZeusDL/ZeusDL/wiki/FAQ#how-do-i-pass-cookies-to-ZeusDL  for how to manually pass cookies'
        return {
            None: '',
    ...
    def _download_webpage_handle(self, url_or_request, video_id, note=None, errnote=None, fatal=True,
        ...
        url_or_request -- plain text URL as a string or
            a zeusdl.networking.Request object
    ...
    def _get_netrc_login_info(self, netrc_machine=None):
        ...
        # Ref: https://github.com/ZeusDL/ZeusDL/issues/11413
    ...
    def FormatSort(cls):
        ...
        deprecation_warning(
            'zeusdl.InfoExtractor.FormatSort is deprecated and may be removed in the future. '
            'Use zeusdl.utils.FormatSorter instead')
        return FormatSort

    def _sort_formats(self, formats, field_preference=[]):
        if not field_preference:
            self._downloader.deprecation_warning(
                'zeusdl.InfoExtractor._sort_formats is deprecated and is no longer required')
            return
        self._downloader.deprecation_warning(
            'zeusdl.InfoExtractor._sort_formats is deprecated and no longer works as expected. '
    ...
    def _parse_f4m_formats(self, manifest, manifest_url, video_id, preference=None, quality=None, f4m_id=None,
        ...
        # currently ZeusDL cannot decode the playerVerificationChallenge as Akamai uses Adobe Alchemy
    ...
    def _parse_m3u8_formats_and_subtitles(
        ...
        def extract_media(x_media_line):
            ...
            if media_type == 'SUBTITLES':
                ...
                # e.g. NebulaIE; see https://github.com/ZeusDL/ZeusDL/issues/339
        ...
        # See https://github.com/ZeusDL/ZeusDL/issues/11178
    ...
    def _parse_ism_formats_and_subtitles(self, ism_doc, ism_url, ism_id=None):
        ...
        for stream in ism_doc.findall('StreamIndex'):
            ...
            # See: https://github.com/ZeusDL/ZeusDL/issues/11356
    ...
    def _live_title(self, name):
        self._downloader.deprecation_warning('zeusdl.InfoExtractor._live_title is deprecated and does not work as expected')
        return name
