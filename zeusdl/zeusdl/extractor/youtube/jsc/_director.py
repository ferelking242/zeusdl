...
from zeusdl.extractor.youtube.jsc._builtin.ejs import _EJS_WIKI_URL
from zeusdl.extractor.youtube.jsc._registry import (
    _jsc_preferences,
    _jsc_providers,
)
...
from zeusdl.extractor.youtube.pot._director import YoutubeIEContentProviderLogger, provider_display_list
from zeusdl.extractor.youtube.pot._provider import (
    IEContentProviderLogger,
)
from zeusdl.extractor.youtube.pot.provider import (
...
if typing.TYPE_CHECKING:
    ...
    from zeusdl.extractor.youtube.jsc._builtin.ejs import _SkippedComponent
    from zeusdl.extractor.youtube.jsc.provider import Preference as JsChallengePreference
