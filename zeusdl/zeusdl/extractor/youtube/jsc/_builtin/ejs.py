...
from zeusdl.dependencies import yt_dlp_ejs as _has_ejs
from zeusdl.extractor.youtube.jsc._builtin import vendor
...
from zeusdl.extractor.youtube.pot._provider import configuration_arg
from zeusdl.extractor.youtube.pot.provider import provider_bug_report_message
from zeusdl.utils import version_tuple
from zeusdl.utils._jsruntime import JsRuntimeInfo
...
if TYPE_CHECKING:
    ...
    from zeusdl.extractor.youtube.jsc.provider import JsChallengeRequest

_EJS_WIKI_URL = 'https://github.com/ZeusDL/ZeusDL/wiki/EJS'
