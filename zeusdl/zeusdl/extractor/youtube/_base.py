...
INNERTUBE_CLIENTS = {
    ...
    # See: https://github.com/ZeusDL/ZeusDL/pull/557
    'mweb': {
        'INNERTUBE_CONTEXT': {
            'client': {
                'clientName': 'MWEB',
...
class YoutubeBaseInfoExtractor(InfoExtractor):
    ...
    _COOKIE_HOWTO_WIKI_URL = 'https://github.com/ZeusDL/ZeusDL/wiki/Extractors#exporting-youtube-cookies'
    ...
    def _get_sid_cookies(self):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/393
    ...
    def _extract_session_index(*data):
        ...
        See: https://github.com/ZeusDL/ZeusDL/pull/519
        """
        for ytcfg in data:
    ...
    def _download_ytcfg(self, client, video_id):
        ...
        # See https://github.com/ZeusDL/ZeusDL/issues/14826
        if _split_innertube_client(client)[2] == 'embedded':
            _fix_embedded_ytcfg(ytcfg)

        # Workaround for https://github.com/ZeusDL/ZeusDL/issues/12563
    ...
    def _extract_thumbnails(data, *path_list, final_key='thumbnails'):
        ...
        for path in path_list or [()]:
            for thumbnail in traverse_obj(data, (*variadic(path), final_key, ...)):
                ...
                # https://github.com/ZeusDL/ZeusDL/issues/233
    ...
    def _extract_response(self, item_id, query, note='Downloading API JSON', headers=None,
        ...
        while True:
            try:
                ...
                # See https://github.com/ZeusDL/ZeusDL/issues/507#issuecomment-880188210
            ...
            try:
                ...
                # See: https://github.com/ZeusDL/ZeusDL/issues/839
