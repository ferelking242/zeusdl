...
from zeusdl.cookies import YoutubeDLCookieJar
...
from zeusdl.extractor.youtube.pot._registry import _pot_providers, _ptp_preferences
from zeusdl.networking import Request, Response
from zeusdl.utils import traverse_obj
from zeusdl.utils.networking import HTTPHeaderDict
...
class PoTokenProvider(IEContentProvider, abc.ABC, suffix='PTP'):
    ...
    # For a list of WebPO client names, see zeusdl.extractor.youtube.pot.utils.WEBPO_CLIENTS.
    # Also see zeusdl.extractor.youtube._base.INNERTUBE_CLIENTS
