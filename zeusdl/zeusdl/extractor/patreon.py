...
class PatreonIE(PatreonBaseIE):
    ...
    _TESTS = [{
        ...
        # m3u8 video (https://github.com/ZeusDL/ZeusDL/issues/2277)
    ...
    def _real_extract(self, url):
        ...
        for include in traverse_obj(post, ('included', lambda _, v: v['type'])):
            ...
            if include_type == 'media':
                ...
                # See: https://github.com/ZeusDL/ZeusDL/issues/4608
...
class PatreonCampaignIE(PatreonBaseIE):
    ...
    _TESTS = [{
        ...
        # next.js v13 data, see https://github.com/ZeusDL/ZeusDL/issues/13622
