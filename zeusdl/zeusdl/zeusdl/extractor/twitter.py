...
class TwitterBaseIE(InfoExtractor):
    ...
    def _call_api(self, path, video_id, query={}, graphql=False):
        ...
        if error_msg := ', '.join(set(traverse_obj(result, ('errors', ..., 'message', {str})))):
            ...
            # See https://github.com/ZeusDL/ZeusDL/issues/15963
    ...
    def _real_extract(self, url):
        ...
        def extract_from_video_info(media):
            ...
            return {
                ...
                # Prioritize m3u8 formats for compat, see https://github.com/ZeusDL/ZeusDL/issues/8117
...
class TwitterSpacesIE(TwitterBaseIE):
    ...
    _TESTS = [{
        ...
        # Needs ffmpeg as downloader, see: https://github.com/ZeusDL/ZeusDL/issues/7536
