...
STREAMING_DATA_CLIENT_NAME = '__zeusdl_client'
STREAMING_DATA_FETCH_SUBS_PO_TOKEN = '__zeusdl_fetch_subs_po_token'
STREAMING_DATA_FETCH_GVS_PO_TOKEN = '__zeusdl_fetch_gvs_po_token'
STREAMING_DATA_PLAYER_TOKEN_PROVIDED = '__zeusdl_player_token_provided'
STREAMING_DATA_INNERTUBE_CONTEXT = '__zeusdl_innertube_context'
STREAMING_DATA_IS_PREMIUM_SUBSCRIBER = '__zeusdl_is_premium_subscriber'
STREAMING_DATA_AVAILABLE_AT_TIMESTAMP = '__zeusdl_available_at_timestamp'

PO_TOKEN_GUIDE_URL = 'https://github.com/ZeusDL/ZeusDL/wiki/PO-Token-Guide'
...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        # Age-gated video
        # https://github.com/ZeusDL/ZeusDL/pull/575#issuecomment-888837000
        ...
        # https://github.com/ZeusDL/ZeusDL/pull/11818
    ...
    def suitable(cls, url):
        from zeusdl.utils import parse_qs
    ...
    def _prepare_live_from_start_formats(self, formats, video_id, live_start_time, url, webpage_url, smuggled_data, is_live):
        ...
        def mpd_feed(itag, client_name, delay):
            ...
            for retry in self.RetryManager(fatal=False):
                ...
                # See https://github.com/ZeusDL/ZeusDL/issues/8543
    ...
    def _extract_from_webpage(cls, url, webpage):
        # Invidious Instances
        # https://github.com/ZeusDL/ZeusDL/issues/195
    ...
    def _comment_entries(self, root_continuation_data, ytcfg, video_id, parent=None, tracker=None, depth=1):
        ...
        def extract_thread(contents, entity_payloads, thread_parent, thread_depth):
            ...
            for content in contents:
                ...
                # See: https://github.com/ZeusDL/ZeusDL/issues/6290
                if comment_id in tracker['seen_comment_ids']:
                    if comment_id in tracker['pinned_comment_ids'] and not comment.get('is_pinned'):
                        ...
                        # See: https://github.com/ZeusDL/ZeusDL/issues/6712
                        continue
                    self.report_warning(
        ...
        for page_num in itertools.count(0):
            ...
            try:
                ...
                # See: https://github.com/ZeusDL/ZeusDL/issues/4669
    ...
    def _extract_player_responses(self, clients, video_id, webpage, webpage_client, webpage_ytcfg, is_premium_subscriber):
        ...
        if initial_pr and not self._invalid_player_response(initial_pr, video_id):
            ...
            # See: https://github.com/ZeusDL/ZeusDL/issues/501
    ...
    def _extract_formats_and_subtitles(self, video_id, player_responses, player_url, live_status, duration):
        ...
        for pr in player_responses:
            ...
            def process_format_stream(fmt_stream, proto, missing_pot, super_resolution=False):
                ...
                if has_drm:
                    ...
                    if client_name == 'tv':
                        msg += (
                            ...
                            f'See  https://github.com/ZeusDL/ZeusDL/issues/12563  for more details.'
                        )
                ...
                # E.g. 2-nOtRESiUc Ref: https://github.com/ZeusDL/ZeusDL/issues/2823
                ...
                dct = {
                    ...
                    'format_note': join_nonempty(
                        ...
                        delim=', '),
                    # Format 22 is likely to be damaged. See https://github.com/ZeusDL/ZeusDL/issues/3372
            ...
            def process_https_formats():
                ...
                for fmt_stream in streaming_formats:
                    ...
                    if not fmt_url:
                        ...
                        # See: https://github.com/ZeusDL/ZeusDL/issues/14883
                        ...
                        if not all((sc, fmt_url, skip_player_js or player_url, encrypted_sig)):
                            msg_tmpl = (
                                ...
                                '{}. See  https://github.com/ZeusDL/ZeusDL/issues/12482  for more details')
    ...
    def _real_extract(self, url):
            ...
            if reason:
                if 'sign in' in reason.lower():
                    ...
                    reason = (
                        ...
                        f'https://github.com/ZeusDL/ZeusDL/wiki/Extractors#this-content-isnt-available-try-again-later'
                    )
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/340
        ...
        def process_language(container, base_url, lang_code, sub_name, client_name, query):
            ...
            for fmt in self._SUBTITLE_FORMATS:
                ...
                # See: https://github.com/ZeusDL/ZeusDL/issues/13654
        ...
        for pr in prs:
            ...
            for caption_track in traverse_obj(pctr, ('captionTracks', lambda _, v: v['baseUrl'])):
                ...
                # e.g. Cantonese [yue], see https://github.com/ZeusDL/ZeusDL/issues/14889
        ...
        # See: https://github.com/ZeusDL/ZeusDL/pull/2223#issuecomment-1008485139
