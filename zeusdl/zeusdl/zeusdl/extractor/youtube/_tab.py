...
class YoutubeTabBaseInfoExtractor(YoutubeBaseInfoExtractor):
    ...
    def _entries(self, tab, item_id, ytcfg, delegated_session_id, visitor_data):
        ...
        for page_num in itertools.count(1):
            ...
            # see: https://github.com/ZeusDL/ZeusDL/issues/12933
    ...
    def _extract_metadata_from_tabs(self, item_id, data):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/2237#issuecomment-1013694714
    ...
    def _extract_webpage(self, url, item_id, fatal=True):
        ...
        for retry in self.RetryManager(fatal=fatal):
            ...
            # See: https://github.com/ZeusDL/ZeusDL/issues/116
...
class YoutubeTabIE(YoutubeTabBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'title': 'ZeusDL test - collaborative playlist',
            'view_count': int,
        ...
        'playlist_mincount': 2,
        'skip': 'https://github.com/ZeusDL/ZeusDL/issues/13690',
    }, {
        ...
        # https://github.com/ZeusDL/ZeusDL/issues/12933
    ...
    def _real_extract(self, url, smuggled_data):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/2694
