...
class ShahidBaseIE(AWSIE):
    ...
    _AWS_API_KEY = __import__('os').environ.get('SHAHID_AWS_API_KEY', '')
    ...
    def _call_api(self, path, video_id, request=None):
        ...
        try:
            return self._aws_execute_api({
                ...
                'secret_key': __import__('os').environ.get('SHAHID_SECRET_KEY', ''),
            }, video_id, query)
    ...
    def _real_extract(self, url):
        ...
        response = self._download_json(
            ...
            video_id, 'Downloading video JSON', query={
                'apiKey': __import__('os').environ.get('SHAHID_API_KEY', ''),
                'hash': __import__('os').environ.get('SHAHID_HASH', ''),
            })
