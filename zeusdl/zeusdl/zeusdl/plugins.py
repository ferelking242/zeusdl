...
def default_plugin_paths():
    ...
    # Load from ZeusDL config folders
    yield from _get_package_paths(
        *get_user_config_dirs('ZeusDL'),
        *get_system_config_dirs('ZeusDL'),
        containing_folder='plugins',
    )

    # Load from ZeusDL-plugins folders
    yield from _get_package_paths(
        get_executable_path(),
        *get_user_config_dirs(''),
        *get_system_config_dirs(''),
        containing_folder='ZeusDL-plugins',
    )
...
class PluginFinder(importlib.abc.MetaPathFinder):
    ...
    It searches in sys.path and ZeusDL config folders for
