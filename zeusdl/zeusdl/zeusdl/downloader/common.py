...
class FileDownloader:
    ...
    def parse_bytes(bytestr):
        ...
        deprecation_warning('zeusdl.FileDownloader.parse_bytes is deprecated and '
                            'may be removed in the future. Use zeusdl.utils.parse_bytes instead')
    ...
    def _report_progress_status(self, s, default_template):
        ...
        self.to_console_title(self.ydl.evaluate_outtmpl(
            progress_template.get('download-title') or 'ZeusDL %(progress._default_template)s',
