...
'''
    ...
    def _gen_cid(self, i, fragment, frag_boundary):
        return f'{i}.{frag_boundary}@ZeusDL.github.io.invalid'
    ...
    def _gen_stub(self, *, fragments, frag_boundary, title):
        ...
        output.write(
            ...
            '<html>'
            '<head>'
            f'<meta name="generator" content="ZeusDL {escapeHTML(YT_DLP_VERSION)}">'
    ...
    def real_download(self, filename, info_dict):
        ...
        if not extra_state['header_written']:
            ...
            ctx['dest_stream'].write((
                'MIME-Version: 1.0\r\n'
                'From: <nowhere@ZeusDL.github.io.invalid>\r\n'
                'To: <nowhere@ZeusDL.github.io.invalid>\r\n'
                f'Subject: {self._escape_mime(title)}\r\n'
                'Content-type: multipart/related; '
                f'boundary="{frag_boundary}"; '
                'type="text/html"\r\n'
                f'X.ZeusDL.Origin: {origin}\r\n'
                '\r\n'
                f'--{frag_boundary}\r\n'
