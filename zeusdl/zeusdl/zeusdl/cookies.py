...
def _extract_firefox_cookies(profile, container, logger):
    ...
    with tempfile.TemporaryDirectory(prefix='zeusdl') as tmpdir:
    ...
    with tempfile.TemporaryDirectory(prefix='zeusdl') as tmpdir:
        ...
        try:
            ...
            if os.name == 'nt' and error.errno == 13:
                message = 'Could not copy Chrome cookie database. See  https://github.com/ZeusDL/ZeusDL/issues/7271  for more info'
...
def _choose_linux_keyring(logger):
    ...
    and so would be aware enough to tell ZeusDL to use the BASIC_TEXT keyring.
...
def _decrypt_windows_dpapi(ciphertext, logger):
    ...
    if not ret:
        message = 'Failed to decrypt with DPAPI. See  https://github.com/ZeusDL/ZeusDL/issues/10927  for more info'
        logger.error(message)
        raise DownloadError(message)  # force exit
...
class LenientSimpleCookie(http.cookies.SimpleCookie):
    ...
    def load(self, data):
        # Workaround for https://github.com/ZeusDL/ZeusDL/issues/4776
...
# This file is generated by ZeusDL.  Do not edit.
                ...
                try:
                    ...
                    if f'{line.strip()} '[0] in '[{"':
                        raise http.cookiejar.LoadError(
                            ...
                            'https://github.com/ZeusDL/ZeusDL/wiki/FAQ#how-do-i-pass-cookies-to-ZeusDL')
