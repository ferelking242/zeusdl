...
if urllib3_version < (2, 0, 2):
    urllib3._zeusdl__version = f'{urllib3.__version__} (unsupported)'
    raise ImportError('Only urllib3 >= 2.0.2 is supported')

if requests.__build__ < 0x023202:
    requests._zeusdl__version = f'{requests.__version__} (unsupported)'
...
class RequestsSession(requests.sessions.Session):
    ...
    def rebuild_method(self, prepared_request, response):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/9020
...
class RequestsRH(RequestHandler, InstanceStoreMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.verbose:
            ...
            # It could technically be problematic for scripts embedding ZeusDL.
    ...
    def close(self):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/8922
