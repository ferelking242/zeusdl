...
class FFmpegPostProcessor(PostProcessor):
    ...
    def available(self):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/12829
    ...
    def stream_copy_opts(copy=True, *, ext=None):
        ...
        # See https://github.com/ZeusDL/ZeusDL/issues/2, #19042, #19024, https://trac.ffmpeg.org/ticket/6016
...
class FFmpegEmbedSubtitlePP(FFmpegPostProcessor):
    ...
    def run(self, info):
        ...
        # See: https://github.com/ZeusDL/ZeusDL/issues/1870, https://github.com/ZeusDL/ZeusDL/issues/1385
        '''
