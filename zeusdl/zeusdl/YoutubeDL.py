...
class YoutubeDL:
    ...
    postprocessors:    A list of dictionaries, each with an entry
                       * key:  The name of the postprocessor. See
                               zeusdl/postprocessor/__init__.py for a list.
    ...
    impersonate:       Client to impersonate for requests.
                       An ImpersonateTarget (from zeusdl.networking.impersonate)
    ...
    warn_when_outdated: Emit a warning if the ZeusDL version is older than 90 days

    The following parameters are not used by YoutubeDL itself, they are used by
    the downloader (see zeusdl/downloader/common.py):
    ...
    def _format_text(self, handle, allow_colors, text, f, fallback=None, *, test_encoding=False):
        ...
        if test_encoding:
            original_text = text
            # handle.encoding can be None. See https://github.com/ZeusDL/ZeusDL/issues/2711
    ...
    def prepare_outtmpl(self, outtmpl, info_dict, sanitize=False):
        ...
        def get_value(mdict):
            ...
            # XXX: Workaround for https://github.com/ZeusDL/ZeusDL/issues/4485
    ...
    def _load_cookies(self, data, *, autoscope=True):
        ...
        See: https://github.com/ZeusDL/ZeusDL/security/advisories/GHSA-v8mc-9377-rwjj
        ...
        for cookie in LenientSimpleCookie(data).values():
            ...
            if domain:
                ...
                self.report_warning(
                    ...
                    f'If you are using ZeusDL with an input URL{bug_reports_message(before=",")}',
                    only_once=True)
    ...
    def __process_playlist(self, ie_result, download):
        ...
        for i, (playlist_index, entry) in enumerate(entries):
            ...
            if self._match_entry(entry_copy, incomplete=True) is not None:
                # For compatabilty with youtube-dl. See https://github.com/ZeusDL/ZeusDL/issues/4369
    ...
    def _check_formats(self, formats, warning=True):
        for f in formats:
            ...
            # Save the actual return code for later. See https://github.com/ZeusDL/ZeusDL/issues/13750
        ...
        if not prefer_best and not can_merge():
            ...
            if evaluate_formats('b/bv+ba') != evaluate_formats('bv*+ba/b'):
                self.report_warning('ffmpeg not found. The downloaded format may not be the best available. '
                                    'Installing ffmpeg is strongly recommended: https://github.com/ZeusDL/ZeusDL#dependencies')
    ...
    def build_format_selector(self, format_spec):
        ...
        #       See: https://github.com/ZeusDL/ZeusDL/pulls/8797
    ...
    def process_video_result(self, info_dict, download=True):
        ...
        for format_id, ambiguous_formats in formats_dict.items():
            ...
            for i, fmt in enumerate(ambiguous_formats):
                ...
                # See https://github.com/ZeusDL/ZeusDL/issues/1282
    ...
    def _unavailable_targets_message(requested_targets, note=None, is_error=False):
        ...
        return (
            ...
            f'  https://github.com/ZeusDL/ZeusDL#impersonation  '
    ...
    def urlopen(self, req):
        ...
        if isinstance(req, str):
            ...
            self.deprecation_warning(
                ...
                'Use zeusdl.networking.common.Request instead.')
        ...
        try:
            ...
            for ue in e.unsupported_errors:
                ...
                if ue.handler.RH_KEY == 'Urllib' and 'unsupported url scheme: "file"' in ue.msg.lower():
                    raise RequestError(
                        'file:// URLs are disabled by default in ZeusDL for security reasons. '
