...
def compat_datetime_from_timestamp(timestamp):
    ...
    # Ref: https://github.com/ZeusDL/ZeusDL/issues/5185, https://github.com/python/cpython/issues/81708,
    # https://github.com/ZeusDL/ZeusDL/issues/6706#issuecomment-1496842642
    return (dt.datetime.fromtimestamp(0, dt.timezone.utc) + dt.timedelta(seconds=timestamp))


# Python 3.8+ does not honor %HOME% on windows, but this breaks compatibility with youtube-dl
# See https://github.com/ZeusDL/ZeusDL/issues/792
