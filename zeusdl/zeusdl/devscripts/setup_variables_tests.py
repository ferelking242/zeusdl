...
def test_setup_variables():
    ...
    BASE_REPO_VARS = {
        'MASTER_ARCHIVE_REPO': 'ZeusDL/ZeusDL-master-builds',
        'NIGHTLY_ARCHIVE_REPO': 'ZeusDL/ZeusDL-nightly-builds',
        'NIGHTLY_PYPI_PROJECT': 'ZeusDL',
    ...
    _test(
        ...
        BASE_REPO_VARS, BASE_REPO_SECRETS, {
            ...
            'target_repo': 'ZeusDL/ZeusDL-nightly-builds',
    ...
    _test(
        ...
        BASE_REPO_VARS, BASE_REPO_SECRETS, {
            ...
            'channel': 'master',
            'version': DEFAULT_VERSION_WITH_REVISION,
            'target_repo': 'ZeusDL/ZeusDL-master-builds',
            'target_tag': DEFAULT_VERSION_WITH_REVISION,
            'pypi_project': None,
            'pypi_suffix': None,
        }, ignore_revision=True)
    ...
    _test(
        FORK_REPOSITORY, 'fork, nightly', {
            'NIGHTLY_ARCHIVE_REPO': f'{FORK_ORG}/ZeusDL-nightly-builds',
            'PYPI_PROJECT': 'ZeusDL-test',
        }, BASE_REPO_SECRETS, {
            'source': f'{FORK_ORG}/ZeusDL-nightly-builds',
            'target': 'nightly',
            'prerelease': True,
        }, {
            'channel': f'{FORK_ORG}/ZeusDL-nightly-builds',
            'version': DEFAULT_VERSION_WITH_REVISION,
            'target_repo': f'{FORK_ORG}/ZeusDL-nightly-builds',
            'target_tag': DEFAULT_VERSION_WITH_REVISION,
            'pypi_project': None,
            'pypi_suffix': None,
        }, ignore_revision=True)
    _test(
        FORK_REPOSITORY, 'fork, master', {
            'MASTER_ARCHIVE_REPO': f'{FORK_ORG}/ZeusDL-master-builds',
            'MASTER_PYPI_PROJECT': 'ZeusDL-test',
            'MASTER_PYPI_SUFFIX': 'dev',
        }, BASE_REPO_SECRETS, {
            'source': f'{FORK_ORG}/ZeusDL-master-builds',
            'target': 'master',
            'prerelease': True,
        }, {
            'channel': f'{FORK_ORG}/ZeusDL-master-builds',
            'version': DEFAULT_VERSION_WITH_REVISION,
            'target_repo': f'{FORK_ORG}/ZeusDL-master-builds',
            'target_tag': DEFAULT_VERSION_WITH_REVISION,
            'pypi_project': 'ZeusDL-test',
            'pypi_suffix': 'dev',
        }, ignore_revision=True)
