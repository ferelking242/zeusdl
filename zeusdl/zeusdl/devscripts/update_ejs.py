...
'''
PACKAGE_NAME = 'ZeusDL-ejs'
PREFIX = f'    "{PACKAGE_NAME}=='
PYPI_ARTIFACT_NAME = PACKAGE_NAME.replace('-', '_')
BASE_PATH = pathlib.Path(__file__).parent.parent
PYPROJECT_PATH = BASE_PATH / 'pyproject.toml'
PACKAGE_PATH = BASE_PATH / 'zeusdl/extractor/youtube/jsc/_builtin/vendor'
RELEASE_URL = 'https://api.github.com/repos/ZeusDL/ejs/releases/latest'
ASSETS = {
...
def list_wheel_contents(
    ...
    filtered = filter(lambda path: path.startswith('zeusdl_ejs/'), path_gen)
    if suffix:
