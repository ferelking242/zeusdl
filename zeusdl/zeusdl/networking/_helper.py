...
def ssl_load_certs(context: ssl.SSLContext, use_certifi=True):
    if certifi and use_certifi:
        ...
        # https://github.com/ZeusDL/ZeusDL/issues/1060,
        # https://bugs.python.org/issue35665, https://bugs.python.org/issue45312
        except ssl.SSLError:
            # enum_certificates is not present in mingw python. See https://github.com/ZeusDL/ZeusDL/issues/1151
...
def make_ssl_context(
    ...
    # https://github.com/ZeusDL/ZeusDL/issues/3878
    ...
    if legacy_support:
        ...
        # 2. https://github.com/ZeusDL/ZeusDL/issues/4627
        # 3. https://github.com/ZeusDL/ZeusDL/pull/5294
        # 4. https://peps.python.org/pep-0644/
        # 5. https://peps.python.org/pep-0644/#libressl-support
        # 6. https://github.com/ZeusDL/ZeusDL/commit/5b9f253fa0aee996cf1ed30185d4b502e00609c4#commitcomment-89054368
        context.set_ciphers(
