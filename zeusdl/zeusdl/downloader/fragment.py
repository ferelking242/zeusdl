...
class FragmentFD(FileDownloader):
    ...
    For each incomplete fragment download ZeusDL keeps on disk a special
    bookkeeping file with download state and metadata (in future such files will
    be used for any incomplete download handled by ZeusDL). This file is
    ...
    def report_retry_fragment(self, err, frag_index, count, retries):
        self.deprecation_warning('zeusdl.downloader.FragmentFD.report_retry_fragment is deprecated. '
                                 'Use zeusdl.downloader.FileDownloader.report_retry instead')
