...
This file aggregates license texts of third-party components included with the ZeusDL PyInstaller-bundled executables.
ZeusDL itself is licensed under the Unlicense (see LICENSE file).
...
DEPENDENCIES: list[Dependency] = [
    ...
    Dependency(
        ...
        comment='Not included in `ZeusDL_x86` and `ZeusDL_musllinux_aarch64` builds',
...
def fetch_text(dep: Dependency) -> str:
    ...
    req = requests.get(dep.license_url, headers={'User-Agent': 'ZeusDL license fetcher'})
