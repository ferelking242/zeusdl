...
from zeusdl.extractor import import_extractors
from zeusdl.extractor.common import InfoExtractor, SearchInfoExtractor
from zeusdl.globals import extractors
...
def main():
    ...
    lazy_extractors_filename = get_filename_args(default_outfile='zeusdl/extractor/lazy_extractors.py')
